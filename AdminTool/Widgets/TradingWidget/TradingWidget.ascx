...
<%@ Register Src="~/AdminTool/Widgets/TradingWidget/MarketLeadersTableRow.ascx" TagName="MarketLeadersTableRow" TagPrefix="uc" %>
<%@ Register Src="~/AdminTool/Widgets/TradingWidget/CurrencyRatesTableRow.ascx" TagName="CurrencyRatesTableRow" TagPrefix="uc" %>
