 ...
 function OnGridDoubleClick(values) {
    ...
    FirstLoading = true;
     p1.SetContentUrl('Module/DanhMuc/Users_Config/PopUp/ThemUsers_Config.aspx?isNew=0&double=1&id=' + values +'&ID_Form='+ID_Form);
     lblTitle.SetText('Chi Tiết Cấu Hình Thành Viên');
  ShowPopup();
  }
 }
 function Refresh() {
 ...
 function XuLyThoat(btnval) {
  ...
  function ThemUsers_Config() {
   FirstLoading = true;
   p1.SetContentUrl('Module/DanhMuc/Users_Config/PopUp/ThemUsers_Config.aspx?isNew=1&double=0&ID_Form='+ID_Form);
  lblTitle.SetText('Thêm Cấu Hình Thành Viên');
  ShowPopup();
  }
 function ChiTietUsers_Config(values) {
    if (values != null || values != "")  {
       FirstLoading = true;
    p1.SetContentUrl('Module/DanhMuc/Users_Config/PopUp/ThemUsers_Config.aspx?isNew=0&double=0&id=' + values + '&ID_Form='+ID_Form);
    lblTitle.SetText('Chi Tiết Cấu Hình Thành Viên');
      ShowPopup();
     }
  }
 ...
 function MinMaxPopup() {
  ...
  {
     hf.Set("Width", w);
     grvUsers_Config.PerformCallback();
  }
  }
   }
