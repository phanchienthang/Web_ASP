 ...
 function OnGridDoubleClick(values) {
    ...
    FirstLoading = true;
     p1.SetContentUrl('Module/DanhMuc/Modules/PopUp/ThemModules.aspx?isNew=0&double=1&id=' + values +'&ID_Form='+ID_Form);
     lblTitle.SetText('Chi Tiết Danh Sách Module');
  ShowPopup();
  }
 }
...
grvModules.Refresh();
 ...
 function XuLyThoat(btnval) {
  ...
  function ThemModules() {
   FirstLoading = true;
   p1.SetContentUrl('Module/DanhMuc/Modules/PopUp/ThemModules.aspx?isNew=1&double=0&ID_Form='+ID_Form);
  lblTitle.SetText('Thêm Danh Sách Module');
  ShowPopup();
  }
 function ChiTietModules(values) {
    if (values != null || values != "")  {
       FirstLoading = true;
    p1.SetContentUrl('Module/DanhMuc/Modules/PopUp/ThemModules.aspx?isNew=0&double=0&id=' + values + '&ID_Form='+ID_Form);
    lblTitle.SetText('Chi Tiết Danh Sách Module');
      ShowPopup();
     }
  }
