 ...
 function OnGridDoubleClick(values) {
    ...
    FirstLoading = true;
     p1.SetContentUrl('Module/DanhMuc/ElementGroup/PopUp/ThemElementGroup.aspx?isNew=0&double=1&id=' + values +'&ID_Form='+ID_Form);
     lblTitle.SetText('Chi Tiết Nhóm Phần Tử Css');
  ShowPopup();
  }
 }
 function setResizeLeftMenu() {
grvElementGroup.Refresh();
 }
 function Refresh() {
 ...
 function XuLyThoat(btnval) {
  ...
  function ThemElementGroup() {
   FirstLoading = true;
   p1.SetContentUrl('Module/DanhMuc/ElementGroup/PopUp/ThemElementGroup.aspx?isNew=1&double=0&ID_Form='+ID_Form);
  lblTitle.SetText('Thêm Nhóm Phần Tử Css');
  ShowPopup();
  }
 function ChiTietElementGroup(values) {
    if (values != null || values != "")  {
       FirstLoading = true;
    p1.SetContentUrl('Module/DanhMuc/ElementGroup/PopUp/ThemElementGroup.aspx?isNew=0&double=0&id=' + values + '&ID_Form='+ID_Form);
    lblTitle.SetText('Chi Tiết Nhóm Phần Tử Css');
      ShowPopup();
     }
  }
 ...
 if (s.cpUpdate) { alertU(); } lp.Hide();
  ...
  {
     hf.Set("Width", w);
     grvElementGroup.PerformCallback();
  }
  }
   }
