 ...
 function OnGridDoubleClick(values) {
    ...
    FirstLoading = true;
     p1.SetContentUrl('Module/DanhMuc/Manufacture/PopUp/ThemManufacture.aspx?isNew=0&double=1&id=' + values +'&ID_Form='+ID_Form);
     lblTitle.SetText('Chi Tiết Manufacture');
  ShowPopup();
  }
 }
 function setResizeLeftMenu() {
grvManufacture.Refresh();
 }
 function Refresh() {
 ...
 function XuLyThoat(btnval) {
  ...
  function ThemManufacture() {
   FirstLoading = true;
   p1.SetContentUrl('Module/DanhMuc/Manufacture/PopUp/ThemManufacture.aspx?isNew=1&double=0&ID_Form='+ID_Form);
  lblTitle.SetText('Thêm Manufacture');
  ShowPopup();
  }
 function ChiTietManufacture(values) {
    if (values != null || values != "")  {
       FirstLoading = true;
    p1.SetContentUrl('Module/DanhMuc/Manufacture/PopUp/ThemManufacture.aspx?isNew=0&double=0&id=' + values + '&ID_Form='+ID_Form);
    lblTitle.SetText('Chi Tiết Manufacture');
      ShowPopup();
     }
  }
 ...
 if (s.cpUpdate) { alertU(); } lp.Hide();
  ...
  {
     hf.Set("Width", w);
     grvManufacture.PerformCallback();
  }
  }
   }
