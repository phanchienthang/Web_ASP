 ...
 function OnGridDoubleClick(values) {
    ...
    FirstLoading = true;
     p1.SetContentUrl('Module/DanhMuc/About/PopUp/ThemAbout.aspx?isNew=0&double=1&id=' + values +'&ID_Form='+ID_Form);
     lblTitle.SetText('Chi Tiết Giới Thiệu');
  ShowPopup();
  }
 }
...
grvAbout.Refresh();
 ...
 function XuLyThoat(btnval) {
  ...
  function ThemAbout() {
   FirstLoading = true;
   p1.SetContentUrl('Module/DanhMuc/About/PopUp/ThemAbout.aspx?isNew=1&double=0&ID_Form='+ID_Form);
  lblTitle.SetText('Thêm Giới Thiệu');
  ShowPopup();
  }
 function ChiTietAbout(values) {
    if (values != null || values != "")  {
       FirstLoading = true;
    p1.SetContentUrl('Module/DanhMuc/About/PopUp/ThemAbout.aspx?isNew=0&double=0&id=' + values + '&ID_Form='+ID_Form);
    lblTitle.SetText('Chi Tiết Giới Thiệu');
      ShowPopup();
     }
  }
