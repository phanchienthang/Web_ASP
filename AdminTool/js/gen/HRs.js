 ...
 function OnGridDoubleClick(values) {
    ...
    FirstLoading = true;
     p1.SetContentUrl('Module/DanhMuc/HRs/PopUp/ThemHRs.aspx?isNew=0&double=1&id=' + values +'&ID_Form='+ID_Form);
     lblTitle.SetText('Chi Tiết Nhân Sự');
  ShowPopup();
  }
 }
...
grvHRs.Refresh();
 ...
 function XuLyThoat(btnval) {
  ...
  function ThemHRs() {
   FirstLoading = true;
   p1.SetContentUrl('Module/DanhMuc/HRs/PopUp/ThemHRs.aspx?isNew=1&double=0&ID_Form='+ID_Form);
  lblTitle.SetText('Thêm Nhân Sự');
  ShowPopup();
  }
 function ChiTietHRs(values) {
    if (values != null || values != "")  {
       FirstLoading = true;
    p1.SetContentUrl('Module/DanhMuc/HRs/PopUp/ThemHRs.aspx?isNew=0&double=0&id=' + values + '&ID_Form='+ID_Form);
    lblTitle.SetText('Chi Tiết Nhân Sự');
      ShowPopup();
     }
  }
