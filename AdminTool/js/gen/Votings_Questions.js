 ...
 function OnGridDoubleClick(values) {
    ...
    FirstLoading = true;
     p1.SetContentUrl('Module/DanhMuc/Votings_Questions/PopUp/ThemVotings_Questions.aspx?isNew=0&double=1&id=' + values +'&ID_Form='+ID_Form);
     lblTitle.SetText('Chi Tiết Câu Hỏi Thăm Dò Ý Kiến');
  ShowPopup();
  }
 }
...
grvVotings_Questions.Refresh();
 ...
 function XuLyThoat(btnval) {
  ...
  function ThemVotings_Questions() {
   FirstLoading = true;
   p1.SetContentUrl('Module/DanhMuc/Votings_Questions/PopUp/ThemVotings_Questions.aspx?isNew=1&double=0&ID_Form='+ID_Form);
  lblTitle.SetText('Thêm Câu Hỏi Thăm Dò Ý Kiến');
  ShowPopup();
  }
 function ChiTietVotings_Questions(values) {
    if (values != null || values != "")  {
       FirstLoading = true;
    p1.SetContentUrl('Module/DanhMuc/Votings_Questions/PopUp/ThemVotings_Questions.aspx?isNew=0&double=0&id=' + values + '&ID_Form='+ID_Form);
    lblTitle.SetText('Chi Tiết Câu Hỏi Thăm Dò Ý Kiến');
      ShowPopup();
     }
  }
 ...
 if (s.cpUpdate) { alertU(); } lp.Hide();
  ...
  {
     hf.Set("Width", w);
     grvVotings_Questions.PerformCallback();
  }
  }
   }
