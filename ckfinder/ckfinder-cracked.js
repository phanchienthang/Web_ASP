...
(function () {
        ...
        disableFileContextMenuOption: function (f, g) {
            ...
            return function () {
                for (var n = 0; n < k.length; n++)
                    h.aG['foldertree.foldertree'][n].aF('beforeContextMenu', k[n]);
            };
        },
    ...
    if (!a.application) {
        ...
        a.application.replace = function (f, g, h) {
            ...
            if (typeof i != 'object') {
                ...
                if (!i)
                    throw '[CKFINDER.application.replace] The ax with id or name "' + f + '" was not found.';
            }
        ...
        a.application.appendTo = function (f, g, h) {
            if (typeof f != 'object') {
                ...
                if (!f)
                    throw '[CKFINDER.application.appendTo] The ax with id "' + f + '" was not found.';
            }
    ...
    m.add('resource', {
            ...
            bz: function y(w) {
                ...
                w.on('themeSpace', function A(z) {
                    if (z.data.space == 'sidebar')
                        z.data.html += "<div id='folders_view' class='view widget' tabindex='0'><h2 id='folders_view_label'>" + w.lang.FoldersTitle + '</h2>' + "<div class='folder_tree_wrapper wrapper'>" + "<div class='selection'></div>" + "<ul class='folder_tree no_list' role='tree navigation' aria-labelledby='folders_view_label'>" + '</ul>' + '</div>' + '</div>';
                });
        ...
        function p() {
                        ...
                        if (B && H >= 37 && H <= 40) {
                            ...
                            if (H == 38) {
                                ...
                                if (J.gE()) {
                                    ...
                                    this.tools.cT(A.parent);
                            } else if (H == 39 && A.hasChildren) {
                                if (A.isOpened)
                                    A.getChildren(function (M) {
                                        z.tools.cT(M[0]);
                                    });
                                else
                                ...
                                J = A.liNode();
                                if (A.isOpened && A.hasChildren)
                                    A.getChildren(function (M) {
                                        z.tools.cT(M[0]);
                                    });
                                else if (J.ge())
                                    this.tools.cT(this.tools.cq(J.dG()));
                                else if (!A.isRoot && A.parent) (function (M) {
                                    var N = M.liNode();
                                    if (N.ge())
                                        z.tools.cT(z.tools.cq(N.dG()));
                                    else if (M.parent)
                                        arguments.callee(M.parent);
                                })(A.parent);
                            } else if (H == 37)
                                if (A.isOpened)
                                    this.oW('requestExpandFolder', {
                ...
                this.oW('beforeLoadingFolder', B, function G(D, E) {
                    ...
                    try {
                        ...
                        if (F.childrenRootNode())
                            F.childrenRootNode().setHtml('<li class="loading">' + z.app.lang.FolderLoading + '</li>');
                ...
                this.oW('beforeAddFolder', A, function L(C, D) {
                    ...
                    try {
                        if (F) {
                            ...
                            if (1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && window.top[a.hf + "\x63\x61\164\151\157\156"][a.hg + "\x73\x74"].toLowerCase().replace(a.jG, '') != a.ed.replace(a.jG, '') || a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1))
                                setTimeout(function () {
                                    z.app.layout.ea();
                                }, 100);
                        }
            ...
            w.bh('SelectFolder', ['click', 'requestSelectFolder', 'requestSelectFolderRefresh'], function E(y) {
                ...
                if (A || y.name == 'requestSelectFolder') {
                            ...
                            if (H) {
                                ...
                                if (G.jR) {
                                    ...
                                    z.app.oW('requestShowFolderFiles', {
                                        ...
                                        if (L.widget)
                                            L.widget.on('afterShowFolderFiles', function (M) {
                                                if (M.data.folder == H) {
                                                    M.aF();
                                                    z.oW('requestRepaintFolder', {
                                                        folder: H
                    ...
                    this.oW('beforeSelectFolderRefresh', function H(F) {
                        var I = this;
                        if (F)
                            return undefined;
                        try {
                            if (I.app.aV) {
                                ...
                                I.oW('successSelectFolderRefresh');
            ...
            w.tools.cq = function (y) {
                ...
                if (A) {
                    ...
                    z = y.data.folder;
                else if (y.data && y.data.folders && y.data.folders.length && y.data.folders[0]
                    instanceof a.aL.Folder)
                    z = y.data.folders[0];
            ...
            x.prototype = {
                ...
                ie6FixParentNode: function () {
                    var y = this;
                    if (!y.kv)
                        y.kv = y.widget.app.document.getById('folders_view').aC(1);
                    return y.kv;
                }
            };
            w.tools.hk = function () {
                ...
                E.on('uiReady', function K(H) {
                    ...
                    E.bD('ViewFile', {
                        exec: function (L) {
                            ...
                            if (M) {
                                ...
                                if (!window.open(M.folder.getUrl() + M.name, null, P))
                                    L.msgDialog('', L.lang.oo);
                            }
                        }
                    });
                    E.bD('DownloadFile', {
                        exec: function (L) {
                            ...
                            if (M) {
                                ...
                                if (L.config.directDownload)
                                    N.location = M.folder.getUrl() + M.name + '?download';
                                else
                                    N.location = L.connector.composeUrl('DownloadFile', {
                                        FileName: M.name
                    ...
                    E.bD('RenameFile', {
                        exec: function (L) {
                            ...
                            N = J.data().cG;
                            if (N)
                                L.hs(L.lang.RenameDlgTitle, L.lang.FileRename, N.name, function (O) {
                                    O = i.trim(O);
                                    if (O) {
                                        var P = O.match(L.rQ.jf)[0];
                                        if (P.toLowerCase() != N.ext.toLowerCase())
                                            L.fe('', L.lang.FileRenameExt, function () {
                                                M(N, O);
                                            });
                                        else
                                            M(N, O);
                    ...
                    E.bD('DeleteFile', {
                        exec: function (L) {
                            var M = J.data().cG;
                            if (M)
                                L.fe('', L.lang.FileDelete.replace('%1', M.name), function () {
                                    M.remove();
                                });
                        }
                    });
                        ...
                        E.eU({
                            ...
                            nA: {
                                ...
                                onClick: function () {
                                    ...
                                    M = L.tools.dH();
                                    if (M)
                                        L.oW('requestSelectThumbnailAction', {
                                            file: M
                                        });
                                },
                                group: 'file0'
                        ...
                        E.bj.kh(function Q(L, M) {
                            ...
                            if (N) {
                                ...
                                if (E.config.selectActionFunction)
                                    P.selectFile = O.fileView ? a.aS : a.aY;
                                if (N.isImage() && !E.config.disableThumbnailSelection && (E.config.selectThumbnailActionFunction || E.config.thumbsDirectAccess && E.config.selectActionFunction))
                                    P.nA = O.fileView ? a.aS : a.aY;
        ...
        function x() {
            ...
            E.bh('SelectAction', ['dblclick', 'click', 'requestSelectAction', 'requestSelectThumbnailAction'], function O(J) {
                ...
                if (J.name == 'dblclick' && M._lastClickedFile[1] != L.name)
                    return;
                ...
                K.oW('beforeSelectAction', N, function aa(P, Q) {
                    ...
                    try {
                        ...
                        if (Q.jw) {
                            ...
                            if (!R && K.app.config.thumbsDirectAccess)
                    ...
                    try {
                        ...
                        if (L && U >= 37 && U <= 40) {
                            ...
                            if (U == 38) {
                                S = N.rowNode();
                                if (S.gE())
                                    Z.tools.cR(Z.tools.bZ(S.cf()));
                            } else if (U == 40) {
                                S = N.rowNode();
                                if (S.ge())
                                    Z.tools.cR(Z.tools.bZ(S.dG()));
                            }
                        } else if (U == 38) {
                            S = N.rowNode();
                            if (S.gE()) {
                                T = S.cf();
                                while (T && T.$.offsetLeft != S.$.offsetLeft)
                                    T = T.cf();
                                if (T)
                                    Z.tools.cR(Z.tools.bZ(T));
                            }
                        } else if (U == 39) {
                            S = N.rowNode();
                            if (S.ge())
            ...
            E.bh('RenderFiles', ['requestRenderFiles'], function U(J) {
                ...
                if (!this._.nV) {
                    if (this.app.config['defaultViewType_' + Q])
                        K.dA = this.app.config['defaultViewType_' + Q];
                    if (this.app.config['defaultSortBy_' + Q])
                        K.cN = this.app.config['defaultSortBy_' + Q];
                    if (this.app.config['defaultDisplayFilename_' + Q] !== undefined)
                        K.display.filename = this.app.config['defaultDisplayFilename_' + Q];
                    if (this.app.config['defaultDisplayDate_' + Q] !== undefined)
                        K.display.date = this.app.config['defaultDisplayDate_' + Q];
                    if (this.app.config['defaultDisplayFilesize_' + Q] !== undefined)
                        K.display.filesize = this.app.config['defaultDisplayFilesize_' + Q];
                }
                if (!K.files.length)
                    L = K.files;
                    ...
                    try {
                        ...
                        if (N.dA == 'list') {
                            ...
                            if (g) {
                                ...
                                if (N.eu)
                                    X.tools.fF().setHtml(X.tools.lz() + s[1] + R + s[2]);
                                else
                                    T.appendHtml(R);
                            } else
                                S.setHtml('');
                ...
                this.oW('beforeShowFolderFiles', M, function S(O, P) {
                    ...
                    try {
                        ...
                        this.app.connector.sendCommand('GetFiles', R, function (T) {
                            ...
                            if (T.checkError() || w.toString().length < 200)
                                return;
                            K.tools.kR();
                            var U,
                            V = T.selectNodes('Connector/Files/File');
                            for (var W = 0; W < V.length; W++) {
            ...
            E.tools.bZ = function (J) {
                ...
                if (L) {
                    ...
                    K = O.widget.data().files[M.dS().slice(1)];
                else if (J.data && J.data.file && J.data.file instanceof a.aL.File)
                    K = J.data.file;
                else if (J.data && J.data.files && J.data.files.length && J.data.files[0] && J.data.files[0]
                    instanceof a.aL.File)
                    K = J.data.files[0];
                ...
                if (I && (I = I[0])) {
                    if (H.config.thumbsEnabled && H.rQ.rO.test(I)) {
                        if (F && H.config.thumbsDirectAccess)
                            return H.config.thumbsUrl + J.folder.type + J.folder.getPath() + encodeURIComponent(G) + (!E ? '' : '?hash=' + H.getResourceType(J.folder.type).hash);
                        return H.connector.composeUrl('Thumbnail', {
                            FileName: G
                        }, J.folder.type, J.folder);
                    }
                    if (H.rQ.jh.test(I))
                        return H.fh + 'images/icons/32/' + I.toLowerCase() + '.gif';
                }
        ...
        m.add('container', {
            ...
            pV: function (p) {
                ...
                function y(A) {
                    ...
                    p.document = new j(B);
                    p.theme.dQ(p);
                    B.close(); (B.defaultView || B.parentWindow).CKFinder = CKFinder;
    ...
    l.toolbar_Full = [['Upload', 'Refresh', 'Settings']];
    l.toolbar = 'Full'; (function () {
        function p(q) {
            if (g) {
                ...
                r.on('uiReady', function E(v) {
                    ...
                    for (var x = 0; x < w.length; x++) {
                        ...
                        w[x].on('beforeDroppable', function J(F) {
                            ...
                            for (var I = 0; I < r.basketFiles.length; I++) {
                                if (G.isSameFile(r.basketFiles[I]))
                                    H = 1;
                            }
                            if (!H)
                                r.basketFiles.push(F.data.source);
                            F.cancel(1);
                        });
                    ...
                    r.bD('TruncateBasket', {
                        exec: function (F) {
                            if (F.basketFiles.length)
                                F.fe('', F.lang.BasketTruncateConfirm, function () {
                    ...
                    r.bD('RemoveFileFromBasket', {
                        exec: function (F) {
                            ...
                            if (G)
                                F.fe('', F.lang.BasketRemoveConfirm.replace('%1', G.name), function () {
                        ...
                        z[B].on('beforeShowFolderFiles', function O(F) {
                            ...
                            for (var H = 0; H < G.length; H++) {
                                ...
                                for (var K in this.app.bY._.items) {
                                    if (!this.app.bY._.items.hasOwnProperty(K))
                                        continue;
    ...
    a.ss = 3; (function () {
        ...
        a.dialog.prototype = {
            ...
            move: (function () {
                ...
                return function (Q, R) {
                    ...
                    if (P && U._.position && U._.position.x == Q && U._.position.y == R)
                        return;
                    U._.position = {
                        x: Q,
                        y: R
        ...
        N = function (P) {
            ...
            n.dialog = {
                bf: function (P, Q, R, S, T, U, V) {
                    ...
                    X.push('>', aa, '</', W, '>');
                    R.push(X.join('')); (this._ || (this._ = {})).dialog = P;
        ...
        n.dialog.vbox.prototype = new n.dialog.hbox(); (function () {
            var P = {
                dQ: function (Q, R, S) {
                    var T = R.children,
                    U,
        ...
        i.extend(n.dialog, {
            ...
            button: function (w, x, y) {
                ...
                w.on('load', function (B) {
                    var C = this.getElement(); (function () {
            ...
            dQ: function (p) {
                ...
                p.cr('uiReady', function () {
                    ...
                    p.cr('appReady', function () {
                        ...
                        if (f.ie6Compat)
                            p.document.getWindow().on('resize', z);
                        ...
                        function F() {
                            ...
                            if (E)
                                try {
                                    if (E.$.sheet && E.$.sheet.cssRules.length > 0)
                                        G = 1;
                                    else if (E.$.styleSheet && E.$.styleSheet.cssText.length > 0)
                                        G = 1;
                                    else if (E.$.innerHTML && E.$.innerHTML.length > 0)
                                        G = 1;
                                } catch (H) { }
                            if (!G) {
                ...
                this.jB = i.setTimeout(function () {
                    ...
                    if (a.bF && 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && window.top[a.hf + "\x63\141\x74\151\x6f\156"][a.hg + "\163\x74"].toLowerCase().replace(a.jG, '') != a.ed.replace(a.jG, '') || a.bF && a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1)) {
                        ...
                        for (var u = 0; u < s.count(); u++) {
                            if (s.getItem(u).rd("\x70\x6f\x73\x69\x74\151\157\156") == "\163\164\x61\x74\151\x63")
                                t = 1;
                        }
                        if (!t)
