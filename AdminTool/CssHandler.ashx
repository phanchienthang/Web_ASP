...
public class CssHandler : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        //  themeName = themeName + themeFileNames + "1";
        ...
        using (MemoryStream memoryStream = new MemoryStream(5000))
        {
                ...
                memoryStream)
            {
                ...
                //string[] commonCssFiles = Styles.Util.ConstantHelper.CommonCssFileName.Split(',');
                //foreach (string fileName in commonCssFiles)
                //{
                //    byte[] fileBytes = this.GetCss(context, fileName,
                //        Styles.Util.ConstantHelper.ImagePrefix, version, encoding);
                ...
                if (!string.IsNullOrEmpty(themeName))
                {
                    ...
                    if (Library.AccessDB.c == "da" && Dropthings.Business.Facade.Facade.getuserSettingRepository() == "ds")
                    {
    ...
    {
        return "CssHandlerAdmin." + themeName + "." + version + "." + isCompressed;
    }
