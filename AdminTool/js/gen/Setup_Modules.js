 ...
 function OnGridDoubleClick(values) {
    ...
    FirstLoading = true;
     p1.SetContentUrl('Module/DanhMuc/Setup_Modules/PopUp/ThemSetup_Modules.aspx?isNew=0&double=1&id=' + values +'&ID_Form='+ID_Form);
     lblTitle.SetText('Chi Tiết Cài Đặt Modules');
  ShowPopup();
  }
 }
 function Refresh() {
 ...
 function XuLyThoat(btnval) {
  ...
  function ThemSetup_Modules() {
   FirstLoading = true;
   p1.SetContentUrl('Module/DanhMuc/Setup_Modules/PopUp/ThemSetup_Modules.aspx?isNew=1&double=0&ID_Form='+ID_Form);
  lblTitle.SetText('Thêm Cài Đặt Modules');
  ShowPopup();
  }
 function ChiTietSetup_Modules(values) {
    if (values != null || values != "")  {
       FirstLoading = true;
    p1.SetContentUrl('Module/DanhMuc/Setup_Modules/PopUp/ThemSetup_Modules.aspx?isNew=0&double=0&id=' + values + '&ID_Form='+ID_Form);
    lblTitle.SetText('Chi Tiết Cài Đặt Modules');
      ShowPopup();
     }
  }
 ...
 function MinMaxPopup() {
  ...
  {
     hf.Set("Width", w);
     grvSetup_Modules.PerformCallback();
  }
  }
   }
