 ...
 function OnGridDoubleClick(values) {
    ...
    FirstLoading = true;
     p1.SetContentUrl('Module/DanhMuc/News_Tags/PopUp/ThemNews_Tags.aspx?isNew=0&double=1&id=' + values +'&ID_Form='+ID_Form);
     lblTitle.SetText('Chi Tiết Tag');
  ShowPopup();
  }
 }
 function setResizeLeftMenu() {
grvNews_Tags.Refresh();
 }
 function Refresh() {
 ...
 function XuLyThoat(btnval) {
  ...
  function ThemNews_Tags() {
   FirstLoading = true;
   p1.SetContentUrl('Module/DanhMuc/News_Tags/PopUp/ThemNews_Tags.aspx?isNew=1&double=0&ID_Form='+ID_Form);
  lblTitle.SetText('Thêm Tag');
  ShowPopup();
  }
 function ChiTietNews_Tags(values) {
    if (values != null || values != "")  {
       FirstLoading = true;
    p1.SetContentUrl('Module/DanhMuc/News_Tags/PopUp/ThemNews_Tags.aspx?isNew=0&double=0&id=' + values + '&ID_Form='+ID_Form);
    lblTitle.SetText('Chi Tiết Tag');
      ShowPopup();
     }
  }
