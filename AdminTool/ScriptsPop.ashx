...
public class Scripts : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
      ...
      //  if (Dropthings.Util.Services.Get<OmarALZabir.AspectF.ICache>().Get(setInfo) == null)
    //    { 
       
            // Find the set
            Styles.Web.Util.Dropthings.Web.Util.UrlMapSet set = Styles.Web.Util.Dropthings.Web.Util.CombineScripts.LoadSets(baseUrl).Find(
        ...
        //    Dropthings.Util.Services.Get<OmarALZabir.AspectF.ICache>().Add(setInfo, encodedBytes);
        //}
        //else
        //{
        //    encodedBytes = Dropthings.Util.Services.Get<OmarALZabir.AspectF.ICache>().Get(setInfo) as byte[];
        //}
