  ...
  (function($, window) {
    ...
    Tour = (function() {
      ...
      Tour.prototype._showPopover = function(step, i) {
        ...
        if (step.end) {
            content += "<a href='#' class='end'>End</a></p>";
        } else {
            content += "<a href='#' class='next'>Tiếp tục &raquo;</a>          <a href='#' class='pull-right end'>Kết thúc</a></p>";
            content += "<div><label><input id='is-tour' type='checkbox'>Không hiển thị nữa</label></div>";
        }
