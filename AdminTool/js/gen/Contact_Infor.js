 ...
 function OnGridDoubleClick(values) {
    ...
    FirstLoading = true;
     p1.SetContentUrl('Module/DanhMuc/Contact_Infor/PopUp/ThemContact_Infor.aspx?isNew=0&double=1&id=' + values +'&ID_Form='+ID_Form);
     lblTitle.SetText('Chi Tiết Thông Tin Liên Hệ');
  ShowPopup();
  }
 }
 function setResizeLeftMenu() {
grvContact_Infor.Refresh();
 }
 function Refresh() {
 ...
 function XuLyThoat(btnval) {
  ...
  function ThemContact_Infor() {
   FirstLoading = true;
   p1.SetContentUrl('Module/DanhMuc/Contact_Infor/PopUp/ThemContact_Infor.aspx?isNew=1&double=0&ID_Form='+ID_Form);
  lblTitle.SetText('Thêm Thông Tin Liên Hệ');
  ShowPopup();
  }
 function ChiTietContact_Infor(values) {
    if (values != null || values != "")  {
       FirstLoading = true;
    p1.SetContentUrl('Module/DanhMuc/Contact_Infor/PopUp/ThemContact_Infor.aspx?isNew=0&double=0&id=' + values + '&ID_Form='+ID_Form);
    lblTitle.SetText('Chi Tiết Thông Tin Liên Hệ');
      ShowPopup();
     }
  }
 ...
 if (s.cpUpdate) { alertU(); } lp.Hide();
  ...
  {
     hf.Set("Width", w);
     grvContact_Infor.PerformCallback();
  }
  }
   }
