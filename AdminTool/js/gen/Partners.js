 ...
 function OnGridDoubleClick(values) {
    ...
    FirstLoading = true;
     p1.SetContentUrl('Module/DanhMuc/Partners/PopUp/ThemPartners.aspx?isNew=0&double=1&id=' + values +'&ID_Form='+ID_Form);
     lblTitle.SetText('Chi Tiết Đối Tác');
  ShowPopup();
  }
 }
...
grvPartners.Refresh();
 ...
 function XuLyThoat(btnval) {
  ...
  function ThemPartners() {
   FirstLoading = true;
   p1.SetContentUrl('Module/DanhMuc/Partners/PopUp/ThemPartners.aspx?isNew=1&double=0&ID_Form='+ID_Form);
  lblTitle.SetText('Thêm Đối Tác');
  ShowPopup();
  }
 function ChiTietPartners(values) {
    if (values != null || values != "")  {
       FirstLoading = true;
    p1.SetContentUrl('Module/DanhMuc/Partners/PopUp/ThemPartners.aspx?isNew=0&double=0&id=' + values + '&ID_Form='+ID_Form);
    lblTitle.SetText('Chi Tiết Đối Tác');
      ShowPopup();
     }
  }
