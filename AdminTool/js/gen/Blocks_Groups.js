 ...
 function OnGridDoubleClick(values) {
    ...
    FirstLoading = true;
     p1.SetContentUrl('Module/DanhMuc/Blocks_Groups/PopUp/ThemBlocks_Groups.aspx?isNew=0&double=1&id=' + values +'&ID_Form='+ID_Form);
     lblTitle.SetText('Chi Tiết Blocks_Groups');
  ShowPopup();
  }
 }
 function Refresh() {
 ...
 function XuLyThoat(btnval) {
  ...
  function ThemBlocks_Groups() {
   FirstLoading = true;
   p1.SetContentUrl('Module/DanhMuc/Blocks_Groups/PopUp/ThemBlocks_Groups.aspx?isNew=1&double=0&ID_Form='+ID_Form);
  lblTitle.SetText('Thêm Blocks_Groups');
  ShowPopup();
  }
 function ChiTietBlocks_Groups(values) {
    if (values != null || values != "")  {
       FirstLoading = true;
    p1.SetContentUrl('Module/DanhMuc/Blocks_Groups/PopUp/ThemBlocks_Groups.aspx?isNew=0&double=0&id=' + values + '&ID_Form='+ID_Form);
    lblTitle.SetText('Chi Tiết Blocks_Groups');
      ShowPopup();
     }
  }
 ...
 function MinMaxPopup() {
  ...
  {
     hf.Set("Width", w);
     grvBlocks_Groups.PerformCallback();
  }
  }
   }
