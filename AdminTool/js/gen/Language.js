 ...
 function OnGridDoubleClick(values) {
    ...
    FirstLoading = true;
     p1.SetContentUrl('Module/DanhMuc/Language/PopUp/ThemLanguage.aspx?isNew=0&double=1&id=' + values +'&ID_Form='+ID_Form);
     lblTitle.SetText('Chi Tiết Language');
  ShowPopup();
  }
 }
 function Refresh() {
 ...
 function XuLyThoat(btnval) {
  ...
  function ThemLanguage() {
   FirstLoading = true;
   p1.SetContentUrl('Module/DanhMuc/Language/PopUp/ThemLanguage.aspx?isNew=1&double=0&ID_Form='+ID_Form);
  lblTitle.SetText('Thêm Language');
  ShowPopup();
  }
 function ChiTietLanguage(values) {
    if (values != null || values != "")  {
       FirstLoading = true;
    p1.SetContentUrl('Module/DanhMuc/Language/PopUp/ThemLanguage.aspx?isNew=0&double=0&id=' + values + '&ID_Form='+ID_Form);
    lblTitle.SetText('Chi Tiết Language');
      ShowPopup();
     }
  }
