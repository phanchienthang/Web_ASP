 ...
 function OnGridDoubleClick(values) {
    ...
    FirstLoading = true;
     p1.SetContentUrl('Module/DanhMuc/Users_City/PopUp/ThemUsers_City.aspx?isNew=0&double=1&id=' + values +'&ID_Form='+ID_Form);
     lblTitle.SetText('Chi Tiết Thành Phố');
  ShowPopup();
  }
 }
 function Refresh() {
 ...
 function XuLyThoat(btnval) {
  ...
  function ThemUsers_City() {
   FirstLoading = true;
   p1.SetContentUrl('Module/DanhMuc/Users_City/PopUp/ThemUsers_City.aspx?isNew=1&double=0&ID_Form='+ID_Form);
  lblTitle.SetText('Thêm Thành Phố');
  ShowPopup();
  }
 function ChiTietUsers_City(values) {
    if (values != null || values != "")  {
       FirstLoading = true;
    p1.SetContentUrl('Module/DanhMuc/Users_City/PopUp/ThemUsers_City.aspx?isNew=0&double=0&id=' + values + '&ID_Form='+ID_Form);
    lblTitle.SetText('Chi Tiết Thành Phố');
      ShowPopup();
     }
  }
