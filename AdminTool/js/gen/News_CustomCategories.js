 ...
 function OnGridDoubleClick(values) {
    ...
    FirstLoading = true;
     p1.SetContentUrl('Module/DanhMuc/News_CustomCategories/PopUp/ThemNews_CustomCategories.aspx?isNew=0&double=1&id=' + values +'&ID_Form='+ID_Form);
     lblTitle.SetText('Chi Tiết Danh Mục Tin Tức Tùy Chọn');
  ShowPopup();
  }
 }
 function setResizeLeftMenu() {
grvNews_CustomCategories.Refresh();
 }
 function Refresh() {
 ...
 function XuLyThoat(btnval) {
  ...
  function ThemNews_CustomCategories() {
   FirstLoading = true;
   p1.SetContentUrl('Module/DanhMuc/News_CustomCategories/PopUp/ThemNews_CustomCategories.aspx?isNew=1&double=0&ID_Form='+ID_Form);
  lblTitle.SetText('Thêm Danh Mục Tin Tức Tùy Chọn');
  ShowPopup();
  }
 function ChiTietNews_CustomCategories(values) {
    if (values != null || values != "")  {
       FirstLoading = true;
    p1.SetContentUrl('Module/DanhMuc/News_CustomCategories/PopUp/ThemNews_CustomCategories.aspx?isNew=0&double=0&id=' + values + '&ID_Form='+ID_Form);
    lblTitle.SetText('Chi Tiết Danh Mục Tin Tức Tùy Chọn');
      ShowPopup();
     }
  }
 ...
 if (s.cpUpdate) { alertU(); } lp.Hide();
  ...
  function OnControlsInitialized(s, e) {
   ...
   var w = window.innerWidth;
       grvNews_CustomCategories.SetHeight(h);
    if (p1.GetContentIFrameWindow().btnLuu)
    {
      var col_h = CalculateSize_Content();
      p1.GetContentIFrameWindow().setHeightFrame(col_h);
  ...
  {
     hf.Set("Width", w);
     grvNews_CustomCategories.PerformCallback();
  }
  }
   }
