 ...
 function OnGridDoubleClick(values) {
    ...
    FirstLoading = true;
     p1.SetContentUrl('Module/DanhMuc/Contact/PopUp/ThemContact.aspx?isNew=0&double=1&id=' + values +'&ID_Form='+ID_Form);
     lblTitle.SetText('Chi Tiết Liên Hệ');
  ShowPopup();
  }
 }
...
grvContact.Refresh();
 ...
 function XuLyThoat(btnval) {
  ...
  function ThemContact() {
   FirstLoading = true;
   p1.SetContentUrl('Module/DanhMuc/Contact/PopUp/ThemContact.aspx?isNew=1&double=0&ID_Form='+ID_Form);
  lblTitle.SetText('Thêm Liên Hệ');
  ShowPopup();
  }
 function ChiTietContact(values) {
    if (values != null || values != "")  {
       FirstLoading = true;
    p1.SetContentUrl('Module/DanhMuc/Contact/PopUp/ThemContact.aspx?isNew=0&double=0&id=' + values + '&ID_Form='+ID_Form);
    lblTitle.SetText('Chi Tiết Liên Hệ');
      ShowPopup();
     }
  }
